...
#you can loop thru a dictionary by using a for loop
...
#you can also use the values() method to return valeus of a dictionary
...
#Loop through both the keys and values , by using the items() method
...
#Access Items in Nested Dictionaries, you use the name of the dictionaries, starting with the outer one
print(myfamily["child2"]["name"])

#loop through a dictionary by using the items() method like this:
